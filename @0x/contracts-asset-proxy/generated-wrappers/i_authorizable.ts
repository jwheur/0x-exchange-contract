...
export class IAuthorizableContract extends BaseContract {
    public addAuthorizedAddress = {
        ...
        const self = this as any as IAuthorizableContract;
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return IAuthorizableContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        logUtils.log(`IAuthorizable successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new IAuthorizableContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('IAuthorizable', IAuthorizableContract.ABI(), address, supportedProvider, txDefaults);
