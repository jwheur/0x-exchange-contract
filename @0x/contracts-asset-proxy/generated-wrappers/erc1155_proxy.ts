...
export class ERC1155ProxyContract extends BaseContract {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return ERC1155ProxyContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        const contractInstance = new ERC1155ProxyContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('ERC1155Proxy', ERC1155ProxyContract.ABI(), address, supportedProvider, txDefaults);
