...
export class StaticCallProxyContract extends BaseContract {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return StaticCallProxyContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        const contractInstance = new StaticCallProxyContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('StaticCallProxy', StaticCallProxyContract.ABI(), address, supportedProvider, txDefaults);
