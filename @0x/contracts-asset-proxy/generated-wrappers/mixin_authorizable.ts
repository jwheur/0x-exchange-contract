...
export class MixinAuthorizableContract extends BaseContract {
    ...
    public static async deployAsync(
        ...
        const contractInstance = new MixinAuthorizableContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('MixinAuthorizable', MixinAuthorizableContract.ABI(), address, supportedProvider, txDefaults);
