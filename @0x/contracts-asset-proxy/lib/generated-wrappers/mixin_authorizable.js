...
var MixinAuthorizableEvents;
(function (MixinAuthorizableEvents) {
    MixinAuthorizableEvents["AuthorizedAddressAdded"] = "AuthorizedAddressAdded";
    MixinAuthorizableEvents["AuthorizedAddressRemoved"] = "AuthorizedAddressRemoved";
})(MixinAuthorizableEvents = exports.MixinAuthorizableEvents || (exports.MixinAuthorizableEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var MixinAuthorizableContract = /** @class */ (function (_super) {
    __extends(MixinAuthorizableContract, _super);
    function MixinAuthorizableContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'MixinAuthorizable', MixinAuthorizableContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.addAuthorizedAddress = {
            ...
            awaitTransactionSuccessAsync: function (target, txData, pollingIntervalMs, timeoutMs) {
                ...
                assert_1.assert.isString('target', target);
                var self = this;
                var txHashPromise = self.addAuthorizedAddress.sendTransactionAsync(target, txData);
        ...
        _this.removeAuthorizedAddress = {
            ...
            awaitTransactionSuccessAsync: function (target, txData, pollingIntervalMs, timeoutMs) {
                ...
                assert_1.assert.isString('target', target);
                var self = this;
                var txHashPromise = self.removeAuthorizedAddress.sendTransactionAsync(target, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
        ...
        _this.removeAuthorizedAddressAtIndex = {
            ...
            awaitTransactionSuccessAsync: function (target, index, txData, pollingIntervalMs, timeoutMs) {
                ...
                assert_1.assert.isBigNumber('index', index);
                var self = this;
                var txHashPromise = self.removeAuthorizedAddressAtIndex.sendTransactionAsync(target, index, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
        ...
        _this.authorized = {
            ...
            getABIEncodedTransactionData: function (index_0) {
                assert_1.assert.isString('index_0', index_0);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('authorized(address)', [index_0
                ]);
                return abiEncodedTransactionData;
            },
        };
    ...
    MixinAuthorizableContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, MixinAuthorizableContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    MixinAuthorizableContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("MixinAuthorizable successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new MixinAuthorizableContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    MixinAuthorizableContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
    ...
    return MixinAuthorizableContract;
}(base_contract_1.BaseContract));
exports.MixinAuthorizableContract = MixinAuthorizableContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=mixin_authorizable.js.map