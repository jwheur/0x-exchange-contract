...
var IAuthorizableContract = /** @class */ (function (_super) {
    ...
    function IAuthorizableContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IAuthorizable', IAuthorizableContract.ABI(), address, supportedProvider, txDefaults) || this;
    ...
    IAuthorizableContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, IAuthorizableContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    IAuthorizableContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new IAuthorizableContract(txReceipt.contractAddress, provider, txDefaults);
