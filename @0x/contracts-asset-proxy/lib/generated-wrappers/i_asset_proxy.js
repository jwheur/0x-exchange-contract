    ...
    function IAssetProxyContract(address, supportedProvider, txDefaults) {
        ...
        _this.transferFrom = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('transferFrom(bytes,address,address,uint256)', [assetData,
                                    from,
                                    to,
                                    amount
                                ]);
            ...
            getABIEncodedTransactionData: function (assetData, from, to, amount) {
                ...
                assert_1.assert.isBigNumber('amount', amount);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('transferFrom(bytes,address,address,uint256)', [assetData,
                    from,
                    to,
                    amount
                ]);
