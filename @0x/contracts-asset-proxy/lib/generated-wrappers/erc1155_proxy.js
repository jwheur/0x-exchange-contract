...
var ERC1155ProxyContract = /** @class */ (function (_super) {
    ...
    function ERC1155ProxyContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'ERC1155Proxy', ERC1155ProxyContract.ABI(), address, supportedProvider, txDefaults) || this;
    ...
    ERC1155ProxyContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, ERC1155ProxyContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    ERC1155ProxyContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new ERC1155ProxyContract(txReceipt.contractAddress, provider, txDefaults);
