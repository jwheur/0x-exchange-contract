...
var StaticCallProxyContract = /** @class */ (function (_super) {
    ...
    function StaticCallProxyContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'StaticCallProxy', StaticCallProxyContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.getProxyId = {
    ...
    StaticCallProxyContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, StaticCallProxyContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    StaticCallProxyContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new StaticCallProxyContract(txReceipt.contractAddress, provider, txDefaults);
