...
var SafeMathContract = /** @class */ (function (_super) {
    ...
    function SafeMathContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'SafeMath', SafeMathContract.ABI(), address, supportedProvider, txDefaults) || this;
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        return _this;
    }
    SafeMathContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, SafeMathContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    SafeMathContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new SafeMathContract(txReceipt.contractAddress, provider, txDefaults);
