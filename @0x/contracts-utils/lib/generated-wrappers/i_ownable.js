...
var IOwnableContract = /** @class */ (function (_super) {
    ...
    function IOwnableContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IOwnable', IOwnableContract.ABI(), address, supportedProvider, txDefaults) || this;
    ...
    IOwnableContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, IOwnableContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    IOwnableContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new IOwnableContract(txReceipt.contractAddress, provider, txDefaults);
