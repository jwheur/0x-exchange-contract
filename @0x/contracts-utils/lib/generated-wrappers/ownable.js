...
var OwnableContract = /** @class */ (function (_super) {
    ...
    function OwnableContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'Ownable', OwnableContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.owner = {
    ...
    OwnableContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, OwnableContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    OwnableContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new OwnableContract(txReceipt.contractAddress, provider, txDefaults);
