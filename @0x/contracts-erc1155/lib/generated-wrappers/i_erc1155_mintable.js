...
var IERC1155MintableEvents;
(function (IERC1155MintableEvents) {
    IERC1155MintableEvents["TransferSingle"] = "TransferSingle";
    IERC1155MintableEvents["TransferBatch"] = "TransferBatch";
    IERC1155MintableEvents["ApprovalForAll"] = "ApprovalForAll";
    IERC1155MintableEvents["URI"] = "URI";
})(IERC1155MintableEvents = exports.IERC1155MintableEvents || (exports.IERC1155MintableEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var IERC1155MintableContract = /** @class */ (function (_super) {
    __extends(IERC1155MintableContract, _super);
    function IERC1155MintableContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IERC1155Mintable', IERC1155MintableContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.balanceOf = {
    ...
    IERC1155MintableContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, IERC1155MintableContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    IERC1155MintableContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IERC1155Mintable successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IERC1155MintableContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    IERC1155MintableContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [
    ...
    return IERC1155MintableContract;
}(base_contract_1.BaseContract));
exports.IERC1155MintableContract = IERC1155MintableContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_erc1155_mintable.js.map