...
var MixinNonFungibleTokenContract = /** @class */ (function (_super) {
    __extends(MixinNonFungibleTokenContract, _super);
    function MixinNonFungibleTokenContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'MixinNonFungibleToken', MixinNonFungibleTokenContract.ABI(), address, supportedProvider, txDefaults) || this;
    ...
    MixinNonFungibleTokenContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, MixinNonFungibleTokenContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    MixinNonFungibleTokenContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("MixinNonFungibleToken successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new MixinNonFungibleTokenContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    MixinNonFungibleTokenContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [
    ...
    return MixinNonFungibleTokenContract;
}(base_contract_1.BaseContract));
exports.MixinNonFungibleTokenContract = MixinNonFungibleTokenContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=mixin_non_fungible_token.js.map