...
export type IERC1155EventArgs =
    | IERC1155TransferSingleEventArgs
    | IERC1155TransferBatchEventArgs
    | IERC1155ApprovalForAllEventArgs
    | IERC1155URIEventArgs;

export enum IERC1155Events {
...
export class IERC1155Contract extends BaseContract {
    public balanceOf = {
        async callAsync(
            owner: string,
            id: BigNumber,
        ...
        > {
            ...
            const self = this as any as IERC1155Contract;
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return IERC1155Contract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        logUtils.log(`IERC1155 successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new IERC1155Contract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('IERC1155', IERC1155Contract.ABI(), address, supportedProvider, txDefaults);
