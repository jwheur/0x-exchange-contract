...
export class MNonFungibleTokenContract extends BaseContract {
    public isNonFungibleItem = {
        ...
        > {
            ...
            const self = this as any as MNonFungibleTokenContract;
    ...
    public isFungible = {
        ...
        > {
            ...
            const self = this as any as MNonFungibleTokenContract;
            const encodedData = self._strictEncodeArguments('isFungible(uint256)', [_d
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                    to: self.address,
        ...
        getABIEncodedTransactionData(
            ...
            assert.isBigNumber('_d', _d);
            const self = this as any as MNonFungibleTokenContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('isFungible(uint256)', [_d
        ]);
            return abiEncodedTransactionData;
        },
    };
    ...
    public static async deployFrom0xArtifactAsync(
    ...
    ): Promise<MNonFungibleTokenContract> {
        ...
        return MNonFungibleTokenContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        logUtils.log(`MNonFungibleToken successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new MNonFungibleTokenContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('MNonFungibleToken', MNonFungibleTokenContract.ABI(), address, supportedProvider, txDefaults);
