...
export class ERC1155MintableContract extends BaseContract {
    ...
    public createWithType = {
        ...
        const self = this as any as ERC1155MintableContract;
        const encodedData = self._strictEncodeArguments('createWithType(uint256,string)', [type_,
    uri
    ]);
        const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
            {
            ...
            self._web3Wrapper.getContractDefaults(),
            self.createWithType.estimateGasAsync.bind(
                self,
                type_,
                uri
            ),
        ...
        assert.isString('uri', uri);
        const self = this as any as ERC1155MintableContract;
        const txHashPromise = self.createWithType.sendTransactionAsync(type_,
    uri
    , txData);
        return new PromiseWithTransactionHash<TransactionReceiptWithDecodedLogs>(
            txHashPromise,
    ...
    uri
        ...
        getABIEncodedTransactionData(
            ...
            assert.isString('uri', uri);
            const self = this as any as ERC1155MintableContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('createWithType(uint256,string)', [type_,
        uri
        ]);
            return abiEncodedTransactionData;
        },
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return ERC1155MintableContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        const contractInstance = new ERC1155MintableContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('ERC1155Mintable', ERC1155MintableContract.ABI(), address, supportedProvider, txDefaults);
