...
export declare enum FeeRecipientAddressScenario {
    BurnAddress = "BURN_ADDRESS",
    EthUserAddress = "ETH_USER_ADDRESS"
}
export declare enum OrderAssetAmountScenario {
    Zero = "ZERO",
    Large = "LARGE",
    Small = "SMALL"
}
export declare enum TakerScenario {
    CorrectlySpecified = "CORRECTLY_SPECIFIED",
    IncorrectlySpecified = "INCORRECTLY_SPECIFIED",
    Unspecified = "UNSPECIFIED"
}
export declare enum ExpirationTimeSecondsScenario {
    InPast = "IN_PAST",
    InFuture = "IN_FUTURE"
}
export declare enum AssetDataScenario {
...
export declare enum TakerAssetFillAmountScenario {
    Zero = "ZERO",
...
export declare enum BalanceAmountScenario {
    Exact = "EXACT",
    TooLow = "TOO_LOW",
    Higher = "HIGHER"
}
export declare enum AllowanceAmountScenario {
    Exact = "EXACT",
    TooLow = "TOO_LOW",
    Higher = "HIGHER",
    Unlimited = "UNLIMITED"
