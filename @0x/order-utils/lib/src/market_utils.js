...
exports.marketUtils = {
    findOrdersThatCoverTakerAssetFillAmount: function (orders, takerAssetFillAmount, opts) {
        return findOrdersThatCoverAssetFillAmount(orders, takerAssetFillAmount, 'marketSell', opts);
    },
    /**
    ...
    findOrdersThatCoverMakerAssetFillAmount: function (orders, makerAssetFillAmount, opts) {
        return findOrdersThatCoverAssetFillAmount(orders, makerAssetFillAmount, 'marketBuy', opts);
    },
    /**
...
function findOrdersThatCoverAssetFillAmount(orders, assetFillAmount, operation, opts) {
    var variablePrefix = operation === 'marketBuy' ? 'Maker' : 'Taker';
    assert_1.assert.doesConformToSchema('orders', orders, json_schemas_1.schemas.ordersSchema);
    ...
    var remainingFillableAssetAmounts = _.get(opts, "remainingFillable" + variablePrefix + "AssetAmounts", _.map(orders, function (order) { return (operation === 'marketBuy' ? order.makerAssetAmount : order.takerAssetAmount); }));
