...
var ERC20TokenContract = /** @class */ (function (_super) {
    ...
    function ERC20TokenContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'ERC20Token', ERC20TokenContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.approve = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('approve(address,uint256)', [_spender, _value]);
        ...
        _this.transfer = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                assert_1.assert.isBigNumber('_value', _value);
                                self = this;
                                encodedData = self._strictEncodeArguments('transfer(address,uint256)', [_to, _value]);
            ...
            getABIEncodedTransactionData: function (_to, _value) {
                ...
                assert_1.assert.isBigNumber('_value', _value);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('transfer(address,uint256)', [_to, _value]);
                return abiEncodedTransactionData;
            },
        };
        _this.allowance = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('allowance(address,address)', [_owner, _spender]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _a.sent();
                                return [4 /*yield*/, self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new ERC20TokenContract(txReceipt.contractAddress, provider, txDefaults);
