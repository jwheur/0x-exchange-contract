...
var ERC20ProxyContract = /** @class */ (function (_super) {
    ...
    function ERC20ProxyContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'ERC20Proxy', ERC20ProxyContract.ABI(), address, supportedProvider, txDefaults) || this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new ERC20ProxyContract(txReceipt.contractAddress, provider, txDefaults);
