...
var OrderValidatorContract = /** @class */ (function (_super) {
    ...
    function OrderValidatorContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'OrderValidator', OrderValidatorContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.getOrderAndTraderInfo = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('getOrderAndTraderInfo((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes),address)', [order, takerAddress]);
            ...
            getABIEncodedTransactionData: function (order, takerAddress) {
                assert_1.assert.isString('takerAddress', takerAddress);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('getOrderAndTraderInfo((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes),address)', [order, takerAddress]);
        ...
        _this.getBalanceAndAllowance = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('getBalanceAndAllowance(address,bytes)', [
                                    target,
                                    assetData,
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
            ...
            getABIEncodedTransactionData: function (target, assetData) {
                assert_1.assert.isString('target', target);
                assert_1.assert.isString('assetData', assetData);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('getBalanceAndAllowance(address,bytes)', [
                    target,
                    assetData,
                ]);
                return abiEncodedTransactionData;
        ...
        _this.getOrdersAndTradersInfo = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('getOrdersAndTradersInfo((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes)[],address[])', [orders, takerAddresses]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _a.sent();
                                return [4 /*yield*/, self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock)];
            ...
            getABIEncodedTransactionData: function (orders, takerAddresses) {
                assert_1.assert.isArray('orders', orders);
                assert_1.assert.isArray('takerAddresses', takerAddresses);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('getOrdersAndTradersInfo((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes)[],address[])', [orders, takerAddresses]);
                return abiEncodedTransactionData;
            },
        };
        _this.getTradersInfo = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('getTradersInfo((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes)[],address[])', [orders, takerAddresses]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _a.sent();
                                return [4 /*yield*/, self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock)];
            ...
            getABIEncodedTransactionData: function (orders, takerAddresses) {
                ...
                assert_1.assert.isArray('takerAddresses', takerAddresses);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('getTradersInfo((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes)[],address[])', [orders, takerAddresses]);
                return abiEncodedTransactionData;
            },
        };
        _this.getERC721TokenOwner = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('getERC721TokenOwner(address,uint256)', [token, tokenId]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _a.sent();
                                return [4 /*yield*/, self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock)];
            ...
            getABIEncodedTransactionData: function (token, tokenId) {
                assert_1.assert.isString('token', token);
                assert_1.assert.isBigNumber('tokenId', tokenId);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('getERC721TokenOwner(address,uint256)', [
                    token,
                    tokenId,
                ]);
                return abiEncodedTransactionData;
        ...
        _this.getBalancesAndAllowances = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('getBalancesAndAllowances(address,bytes[])', [
                                    target,
                                    assetData,
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
            ...
            getABIEncodedTransactionData: function (target, assetData) {
                ...
                assert_1.assert.isArray('assetData', assetData);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('getBalancesAndAllowances(address,bytes[])', [
                    target,
                    assetData,
                ]);
                return abiEncodedTransactionData;
        ...
        _this.getTraderInfo = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('getTraderInfo((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes),address)', [order, takerAddress]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _a.sent();
                                return [4 /*yield*/, self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock)];
            ...
            getABIEncodedTransactionData: function (order, takerAddress) {
                assert_1.assert.isString('takerAddress', takerAddress);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('getTraderInfo((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes),address)', [order, takerAddress]);
                return abiEncodedTransactionData;
            },
        };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = __read(base_contract_1.BaseContract._formatABIDataItemList(constructorAbi.inputs, [_exchange, _zrxAssetData], base_contract_1.BaseContract._bigNumberToString), 2), _exchange = _a[0], _zrxAssetData = _a[1];
                        iface = new ethers.utils.Interface(abi);
                        deployInfo = iface.deployFunction;
                        txData = deployInfo.encode(bytecode, [_exchange, _zrxAssetData]);
                    ...
                    case 3:
                        ...
                        contractInstance = new OrderValidatorContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    OrderValidatorContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [
