...
var ERC721TokenContract = /** @class */ (function (_super) {
    ...
    function ERC721TokenContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'ERC721Token', ERC721TokenContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.getApproved = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new ERC721TokenContract(txReceipt.contractAddress, provider, txDefaults);
