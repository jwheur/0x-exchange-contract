...
var ERC721ProxyContract = /** @class */ (function (_super) {
    ...
    function ERC721ProxyContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'ERC721Proxy', ERC721ProxyContract.ABI(), address, supportedProvider, txDefaults) || this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new ERC721ProxyContract(txReceipt.contractAddress, provider, txDefaults);
