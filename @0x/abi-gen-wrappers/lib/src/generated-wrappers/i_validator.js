...
var IValidatorContract = /** @class */ (function (_super) {
    ...
    function IValidatorContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IValidator', IValidatorContract.ABI(), address, supportedProvider, txDefaults) || this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new IValidatorContract(txReceipt.contractAddress, provider, txDefaults);
