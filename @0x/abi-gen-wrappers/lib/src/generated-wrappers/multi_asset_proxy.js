...
var MultiAssetProxyContract = /** @class */ (function (_super) {
    ...
    function MultiAssetProxyContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'MultiAssetProxy', MultiAssetProxyContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.assetProxies = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new MultiAssetProxyContract(txReceipt.contractAddress, provider, txDefaults);
