...
var IAssetProxyContract = /** @class */ (function (_super) {
    ...
    function IAssetProxyContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IAssetProxy', IAssetProxyContract.ABI(), address, supportedProvider, txDefaults) || this;
        ...
        _this.removeAuthorizedAddressAtIndex = {
            ...
            getABIEncodedTransactionData: function (target, index) {
                ...
                assert_1.assert.isBigNumber('index', index);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('removeAuthorizedAddressAtIndex(address,uint256)', [target, index]);
                return abiEncodedTransactionData;
            },
        };
        _this.transferFrom = {
            ...
            awaitTransactionSuccessAsync: function (assetData, from, to, amount, txData, pollingIntervalMs, timeoutMs) {
                ...
                assert_1.assert.isBigNumber('amount', amount);
                var self = this;
                var txHashPromise = self.transferFrom.sendTransactionAsync(assetData, from, to, amount, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            getABIEncodedTransactionData: function (assetData, from, to, amount) {
                ...
                assert_1.assert.isBigNumber('amount', amount);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('transferFrom(bytes,address,address,uint256)', [assetData, from, to, amount]);
                return abiEncodedTransactionData;
            },
        };
        _this.getProxyId = {
    ...
    IAssetProxyContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, IAssetProxyContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    IAssetProxyContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new IAssetProxyContract(txReceipt.contractAddress, provider, txDefaults);
