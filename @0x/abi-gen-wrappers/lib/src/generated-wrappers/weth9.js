...
var WETH9Contract = /** @class */ (function (_super) {
    ...
    function WETH9Contract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'WETH9', WETH9Contract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.name = {
        ...
        _this.approve = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('approve(address,uint256)', [guy, wad]);
            ...
            awaitTransactionSuccessAsync: function (guy, wad, txData, pollingIntervalMs, timeoutMs) {
                ...
                assert_1.assert.isBigNumber('wad', wad);
                var self = this;
                var txHashPromise = self.approve.sendTransactionAsync(guy, wad, txData);
            ...
            getABIEncodedTransactionData: function (guy, wad) {
                ...
                assert_1.assert.isBigNumber('wad', wad);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('approve(address,uint256)', [guy, wad]);
                return abiEncodedTransactionData;
            },
        };
        _this.totalSupply = {
        ...
        _this.transferFrom = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                assert_1.assert.isBigNumber('wad', wad);
                                self = this;
                                encodedData = self._strictEncodeArguments('transferFrom(address,address,uint256)', [src, dst, wad]);
            ...
            awaitTransactionSuccessAsync: function (src, dst, wad, txData, pollingIntervalMs, timeoutMs) {
                ...
                assert_1.assert.isBigNumber('wad', wad);
                var self = this;
                var txHashPromise = self.transferFrom.sendTransactionAsync(src, dst, wad, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
        ...
        _this.balanceOf = {
            ...
            getABIEncodedTransactionData: function (index_0) {
                assert_1.assert.isString('index_0', index_0);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('balanceOf(address)', [index_0]);
                return abiEncodedTransactionData;
            },
        };
        _this.symbol = {
        ...
        _this.transfer = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                assert_1.assert.isBigNumber('wad', wad);
                                self = this;
                                encodedData = self._strictEncodeArguments('transfer(address,uint256)', [dst, wad]);
            ...
            awaitTransactionSuccessAsync: function (dst, wad, txData, pollingIntervalMs, timeoutMs) {
                ...
                assert_1.assert.isBigNumber('wad', wad);
                var self = this;
                var txHashPromise = self.transfer.sendTransactionAsync(dst, wad, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            getABIEncodedTransactionData: function (dst, wad) {
                ...
                assert_1.assert.isBigNumber('wad', wad);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('transfer(address,uint256)', [dst, wad]);
                return abiEncodedTransactionData;
            },
        };
        _this.deposit = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('allowance(address,address)', [index_0, index_1]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _a.sent();
                                return [4 /*yield*/, self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new WETH9Contract(txReceipt.contractAddress, provider, txDefaults);
