...
var IERC721TokenEvents;
(function (IERC721TokenEvents) {
    IERC721TokenEvents["Transfer"] = "Transfer";
    IERC721TokenEvents["Approval"] = "Approval";
    IERC721TokenEvents["ApprovalForAll"] = "ApprovalForAll";
})(IERC721TokenEvents = exports.IERC721TokenEvents || (exports.IERC721TokenEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var IERC721TokenContract = /** @class */ (function (_super) {
    __extends(IERC721TokenContract, _super);
    function IERC721TokenContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IERC721Token', IERC721TokenContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.getApproved = {
        ...
        _this.isApprovedForAll = {
            ...
            getABIEncodedTransactionData: function (_owner, _operator) {
                ...
                assert_1.assert.isString('_operator', _operator);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('isApprovedForAll(address,address)', [_owner,
                    _operator
                ]);
                return abiEncodedTransactionData;
            },
    ...
    IERC721TokenContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, IERC721TokenContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    IERC721TokenContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IERC721Token successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IERC721TokenContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    IERC721TokenContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [
    ...
    return IERC721TokenContract;
}(base_contract_1.BaseContract));
exports.IERC721TokenContract = IERC721TokenContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_erc721_token.js.map