...
var InvalidERC721ReceiverEvents;
(function (InvalidERC721ReceiverEvents) {
    InvalidERC721ReceiverEvents["TokenReceived"] = "TokenReceived";
})(InvalidERC721ReceiverEvents = exports.InvalidERC721ReceiverEvents || (exports.InvalidERC721ReceiverEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var InvalidERC721ReceiverContract = /** @class */ (function (_super) {
    __extends(InvalidERC721ReceiverContract, _super);
    function InvalidERC721ReceiverContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'InvalidERC721Receiver', InvalidERC721ReceiverContract.ABI(), address, supportedProvider, txDefaults) || this;
    ...
    InvalidERC721ReceiverContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, InvalidERC721ReceiverContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    InvalidERC721ReceiverContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("InvalidERC721Receiver successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new InvalidERC721ReceiverContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    InvalidERC721ReceiverContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
    ...
    return InvalidERC721ReceiverContract;
}(base_contract_1.BaseContract));
exports.InvalidERC721ReceiverContract = InvalidERC721ReceiverContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=invalid_erc721_receiver.js.map