...
var MintableERC721TokenEvents;
(function (MintableERC721TokenEvents) {
    MintableERC721TokenEvents["Transfer"] = "Transfer";
    MintableERC721TokenEvents["Approval"] = "Approval";
    MintableERC721TokenEvents["ApprovalForAll"] = "ApprovalForAll";
})(MintableERC721TokenEvents = exports.MintableERC721TokenEvents || (exports.MintableERC721TokenEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var MintableERC721TokenContract = /** @class */ (function (_super) {
    __extends(MintableERC721TokenContract, _super);
    function MintableERC721TokenContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'MintableERC721Token', MintableERC721TokenContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.getApproved = {
    ...
    MintableERC721TokenContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, MintableERC721TokenContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    MintableERC721TokenContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("MintableERC721Token successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new MintableERC721TokenContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    MintableERC721TokenContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [
...
//# sourceMappingURL=mintable_erc721_token.js.map