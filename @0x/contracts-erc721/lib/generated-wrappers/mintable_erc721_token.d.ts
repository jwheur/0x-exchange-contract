...
export declare type MintableERC721TokenEventArgs = MintableERC721TokenTransferEventArgs | MintableERC721TokenApprovalEventArgs | MintableERC721TokenApprovalForAllEventArgs;
export declare enum MintableERC721TokenEvents {
    Transfer = "Transfer",
    Approval = "Approval",
...
export declare class MintableERC721TokenContract extends BaseContract {
    ...
    static deployFrom0xArtifactAsync(artifact: ContractArtifact | SimpleContractArtifact, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<MintableERC721TokenContract>;
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<MintableERC721TokenContract>;
    /**
...
//# sourceMappingURL=mintable_erc721_token.d.ts.map