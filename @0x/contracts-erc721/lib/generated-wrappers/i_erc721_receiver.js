...
var IERC721ReceiverContract = /** @class */ (function (_super) {
    __extends(IERC721ReceiverContract, _super);
    function IERC721ReceiverContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IERC721Receiver', IERC721ReceiverContract.ABI(), address, supportedProvider, txDefaults) || this;
    ...
    IERC721ReceiverContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, IERC721ReceiverContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    IERC721ReceiverContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IERC721Receiver successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IERC721ReceiverContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    IERC721ReceiverContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
    ...
    return IERC721ReceiverContract;
}(base_contract_1.BaseContract));
exports.IERC721ReceiverContract = IERC721ReceiverContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_erc721_receiver.js.map