...
export type MintableERC721TokenEventArgs =
    | MintableERC721TokenTransferEventArgs
    | MintableERC721TokenApprovalEventArgs
    | MintableERC721TokenApprovalForAllEventArgs;

export enum MintableERC721TokenEvents {
    Transfer = 'Transfer',
    Approval = 'Approval',
    ApprovalForAll = 'ApprovalForAll',
}

export interface MintableERC721TokenTransferEventArgs extends DecodedLogArgs {
    _from: string;
    _to: string;
    _tokenId: BigNumber;
}

export interface MintableERC721TokenApprovalEventArgs extends DecodedLogArgs {
    _owner: string;
    _approved: string;
    _tokenId: BigNumber;
}

export interface MintableERC721TokenApprovalForAllEventArgs extends DecodedLogArgs {
    _owner: string;
    _operator: string;
    _approved: boolean;
}
...
export class MintableERC721TokenContract extends BaseContract {
    public getApproved = {
        ...
        > {
            ...
            const self = this as any as MintableERC721TokenContract;
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return MintableERC721TokenContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        logUtils.log(`MintableERC721Token successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new MintableERC721TokenContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('MintableERC721Token', MintableERC721TokenContract.ABI(), address, supportedProvider, txDefaults);
