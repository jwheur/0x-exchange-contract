...
export class DummyERC721ReceiverContract extends BaseContract {
    ...
    public static async deployAsync(
        ...
        const contractInstance = new DummyERC721ReceiverContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('DummyERC721Receiver', DummyERC721ReceiverContract.ABI(), address, supportedProvider, txDefaults);
