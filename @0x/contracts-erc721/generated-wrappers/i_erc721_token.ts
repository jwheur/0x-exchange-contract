...
export type IERC721TokenEventArgs =
    | IERC721TokenTransferEventArgs
    | IERC721TokenApprovalEventArgs
    | IERC721TokenApprovalForAllEventArgs;

export enum IERC721TokenEvents {
    Transfer = 'Transfer',
    Approval = 'Approval',
...
export class IERC721TokenContract extends BaseContract {
    public getApproved = {
        async callAsync(
            _tokenId: BigNumber,
        ...
        > {
            ...
            const self = this as any as IERC721TokenContract;
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return IERC721TokenContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        logUtils.log(`IERC721Token successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new IERC721TokenContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('IERC721Token', IERC721TokenContract.ABI(), address, supportedProvider, txDefaults);
