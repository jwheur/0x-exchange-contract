...
export class InvalidERC721ReceiverContract extends BaseContract {
    ...
    public static async deployAsync(
        ...
        const contractInstance = new InvalidERC721ReceiverContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('InvalidERC721Receiver', InvalidERC721ReceiverContract.ABI(), address, supportedProvider, txDefaults);
