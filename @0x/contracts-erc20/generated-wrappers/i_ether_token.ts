...
export type IEtherTokenEventArgs =
    | IEtherTokenTransferEventArgs
    | IEtherTokenApprovalEventArgs;

export enum IEtherTokenEvents {
    Transfer = 'Transfer',
    Approval = 'Approval',
}
...
export class IEtherTokenContract extends BaseContract {
    public approve = {
        ...
        const self = this as any as IEtherTokenContract;
    ...
    public withdraw = {
        ...
        assert.isBigNumber('amount', amount);
        const self = this as any as IEtherTokenContract;
        const txHashPromise = self.withdraw.sendTransactionAsync(amount
    , txData);
        return new PromiseWithTransactionHash<TransactionReceiptWithDecodedLogs>(
            txHashPromise,
            (async (): Promise<TransactionReceiptWithDecodedLogs> => {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return IEtherTokenContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        logUtils.log(`IEtherToken successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new IEtherTokenContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('IEtherToken', IEtherTokenContract.ABI(), address, supportedProvider, txDefaults);
