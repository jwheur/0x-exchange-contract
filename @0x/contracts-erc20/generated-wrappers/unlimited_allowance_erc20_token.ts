...
export type UnlimitedAllowanceERC20TokenEventArgs =
    | UnlimitedAllowanceERC20TokenTransferEventArgs
    | UnlimitedAllowanceERC20TokenApprovalEventArgs;

export enum UnlimitedAllowanceERC20TokenEvents {
    Transfer = 'Transfer',
    Approval = 'Approval',
}

export interface UnlimitedAllowanceERC20TokenTransferEventArgs extends DecodedLogArgs {
    _from: string;
    _to: string;
    _value: BigNumber;
}

export interface UnlimitedAllowanceERC20TokenApprovalEventArgs extends DecodedLogArgs {
    _owner: string;
    _spender: string;
    _value: BigNumber;
}
...
export class UnlimitedAllowanceERC20TokenContract extends BaseContract {
    public approve = {
        ...
        const self = this as any as UnlimitedAllowanceERC20TokenContract;
    ...
    public static async deployFrom0xArtifactAsync(
    ...
    ): Promise<UnlimitedAllowanceERC20TokenContract> {
        ...
        return UnlimitedAllowanceERC20TokenContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        logUtils.log(`UnlimitedAllowanceERC20Token successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new UnlimitedAllowanceERC20TokenContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('UnlimitedAllowanceERC20Token', UnlimitedAllowanceERC20TokenContract.ABI(), address, supportedProvider, txDefaults);
