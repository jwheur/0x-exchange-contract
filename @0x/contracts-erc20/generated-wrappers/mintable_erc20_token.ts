...
export type MintableERC20TokenEventArgs =
    | MintableERC20TokenTransferEventArgs
    | MintableERC20TokenApprovalEventArgs;

export enum MintableERC20TokenEvents {
    Transfer = 'Transfer',
    Approval = 'Approval',
}

export interface MintableERC20TokenTransferEventArgs extends DecodedLogArgs {
    _from: string;
    _to: string;
    _value: BigNumber;
}

export interface MintableERC20TokenApprovalEventArgs extends DecodedLogArgs {
    _owner: string;
    _spender: string;
    _value: BigNumber;
}
...
export class MintableERC20TokenContract extends BaseContract {
    public approve = {
        ...
        const self = this as any as MintableERC20TokenContract;
    ...
    public static async deployFrom0xArtifactAsync(
    ...
    ): Promise<MintableERC20TokenContract> {
        ...
        return MintableERC20TokenContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        logUtils.log(`MintableERC20Token successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new MintableERC20TokenContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('MintableERC20Token', MintableERC20TokenContract.ABI(), address, supportedProvider, txDefaults);
