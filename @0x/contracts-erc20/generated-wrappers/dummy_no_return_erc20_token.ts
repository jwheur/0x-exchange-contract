...
_totalSupply
        ...
        const contractInstance = new DummyNoReturnERC20TokenContract(txReceipt.contractAddress as string, provider, txDefaults);
...
_totalSupply
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('DummyNoReturnERC20Token', DummyNoReturnERC20TokenContract.ABI(), address, supportedProvider, txDefaults);
