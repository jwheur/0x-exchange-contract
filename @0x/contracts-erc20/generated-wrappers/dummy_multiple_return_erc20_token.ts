...
_totalSupply
        ...
        const contractInstance = new DummyMultipleReturnERC20TokenContract(txReceipt.contractAddress as string, provider, txDefaults);
...
_totalSupply
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('DummyMultipleReturnERC20Token', DummyMultipleReturnERC20TokenContract.ABI(), address, supportedProvider, txDefaults);
