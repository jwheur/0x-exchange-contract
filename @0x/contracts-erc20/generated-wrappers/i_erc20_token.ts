...
export type IERC20TokenEventArgs =
    | IERC20TokenTransferEventArgs
    | IERC20TokenApprovalEventArgs;

export enum IERC20TokenEvents {
    Transfer = 'Transfer',
    Approval = 'Approval',
}

export interface IERC20TokenTransferEventArgs extends DecodedLogArgs {
    _from: string;
    _to: string;
    _value: BigNumber;
}

export interface IERC20TokenApprovalEventArgs extends DecodedLogArgs {
    _owner: string;
    _spender: string;
    _value: BigNumber;
}
...
export class IERC20TokenContract extends BaseContract {
    public approve = {
        ...
        const self = this as any as IERC20TokenContract;
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return IERC20TokenContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        logUtils.log(`IERC20Token successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new IERC20TokenContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('IERC20Token', IERC20TokenContract.ABI(), address, supportedProvider, txDefaults);
