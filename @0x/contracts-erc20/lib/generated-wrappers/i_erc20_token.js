...
var IERC20TokenEvents;
(function (IERC20TokenEvents) {
    IERC20TokenEvents["Transfer"] = "Transfer";
    IERC20TokenEvents["Approval"] = "Approval";
})(IERC20TokenEvents = exports.IERC20TokenEvents || (exports.IERC20TokenEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var IERC20TokenContract = /** @class */ (function (_super) {
    __extends(IERC20TokenContract, _super);
    function IERC20TokenContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IERC20Token', IERC20TokenContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.approve = {
    ...
    IERC20TokenContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, IERC20TokenContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    IERC20TokenContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IERC20Token successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IERC20TokenContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    IERC20TokenContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
    ...
    return IERC20TokenContract;
}(base_contract_1.BaseContract));
exports.IERC20TokenContract = IERC20TokenContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_erc20_token.js.map