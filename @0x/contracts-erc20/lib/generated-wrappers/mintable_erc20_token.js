...
var MintableERC20TokenEvents;
(function (MintableERC20TokenEvents) {
    MintableERC20TokenEvents["Transfer"] = "Transfer";
    MintableERC20TokenEvents["Approval"] = "Approval";
})(MintableERC20TokenEvents = exports.MintableERC20TokenEvents || (exports.MintableERC20TokenEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var MintableERC20TokenContract = /** @class */ (function (_super) {
    __extends(MintableERC20TokenContract, _super);
    function MintableERC20TokenContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'MintableERC20Token', MintableERC20TokenContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.approve = {
    ...
    MintableERC20TokenContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, MintableERC20TokenContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    MintableERC20TokenContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("MintableERC20Token successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new MintableERC20TokenContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    MintableERC20TokenContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
    ...
    return MintableERC20TokenContract;
}(base_contract_1.BaseContract));
exports.MintableERC20TokenContract = MintableERC20TokenContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=mintable_erc20_token.js.map