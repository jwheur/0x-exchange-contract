...
export declare type IERC20TokenEventArgs = IERC20TokenTransferEventArgs | IERC20TokenApprovalEventArgs;
export declare enum IERC20TokenEvents {
    Transfer = "Transfer",
    Approval = "Approval"
}
...
export declare class IERC20TokenContract extends BaseContract {
    approve: {
    ...
    static deployFrom0xArtifactAsync(artifact: ContractArtifact | SimpleContractArtifact, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<IERC20TokenContract>;
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<IERC20TokenContract>;
    /**
...
//# sourceMappingURL=i_erc20_token.d.ts.map