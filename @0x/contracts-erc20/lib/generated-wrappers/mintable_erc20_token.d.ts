...
export declare type MintableERC20TokenEventArgs = MintableERC20TokenTransferEventArgs | MintableERC20TokenApprovalEventArgs;
export declare enum MintableERC20TokenEvents {
    Transfer = "Transfer",
    Approval = "Approval"
}
...
export declare class MintableERC20TokenContract extends BaseContract {
    approve: {
    ...
    static deployFrom0xArtifactAsync(artifact: ContractArtifact | SimpleContractArtifact, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<MintableERC20TokenContract>;
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<MintableERC20TokenContract>;
    /**
...
//# sourceMappingURL=mintable_erc20_token.d.ts.map