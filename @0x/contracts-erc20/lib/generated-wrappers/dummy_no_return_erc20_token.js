...
var DummyNoReturnERC20TokenEvents;
(function (DummyNoReturnERC20TokenEvents) {
    DummyNoReturnERC20TokenEvents["Transfer"] = "Transfer";
    DummyNoReturnERC20TokenEvents["Approval"] = "Approval";
})(DummyNoReturnERC20TokenEvents = exports.DummyNoReturnERC20TokenEvents || (exports.DummyNoReturnERC20TokenEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var DummyNoReturnERC20TokenContract = /** @class */ (function (_super) {
    __extends(DummyNoReturnERC20TokenContract, _super);
    function DummyNoReturnERC20TokenContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'DummyNoReturnERC20Token', DummyNoReturnERC20TokenContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.name = {
    ...
    DummyNoReturnERC20TokenContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, _name, _symbol, _decimals, _totalSupply) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, DummyNoReturnERC20TokenContract.deployAsync(bytecode, abi, provider, txDefaults, _name, _symbol, _decimals, _totalSupply)];
            });
        });
    };
    DummyNoReturnERC20TokenContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, _name, _symbol, _decimals, _totalSupply) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        txReceipt = _b.sent();
                        utils_1.logUtils.log("DummyNoReturnERC20Token successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new DummyNoReturnERC20TokenContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    DummyNoReturnERC20TokenContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [],
    ...
    return DummyNoReturnERC20TokenContract;
}(base_contract_1.BaseContract));
exports.DummyNoReturnERC20TokenContract = DummyNoReturnERC20TokenContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=dummy_no_return_erc20_token.js.map