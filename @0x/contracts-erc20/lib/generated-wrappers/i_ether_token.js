...
var IEtherTokenEvents;
(function (IEtherTokenEvents) {
    IEtherTokenEvents["Transfer"] = "Transfer";
    IEtherTokenEvents["Approval"] = "Approval";
})(IEtherTokenEvents = exports.IEtherTokenEvents || (exports.IEtherTokenEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var IEtherTokenContract = /** @class */ (function (_super) {
    __extends(IEtherTokenContract, _super);
    function IEtherTokenContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IEtherToken', IEtherTokenContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.approve = {
        ...
        _this.withdraw = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('withdraw(uint256)', [amount
                                ]);
            ...
            awaitTransactionSuccessAsync: function (amount, txData, pollingIntervalMs, timeoutMs) {
                var _this = this;
                assert_1.assert.isBigNumber('amount', amount);
                var self = this;
                var txHashPromise = self.withdraw.sendTransactionAsync(amount, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            callAsync: function (amount, callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, encodedData, callDataWithDefaults, rawCallResult, abiEncoder, result;
                    return __generator(this, function (_a) {
            ...
            getABIEncodedTransactionData: function (amount) {
                assert_1.assert.isBigNumber('amount', amount);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('withdraw(uint256)', [amount
                ]);
                return abiEncodedTransactionData;
            },
        };
    ...
    IEtherTokenContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, IEtherTokenContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    IEtherTokenContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IEtherToken successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IEtherTokenContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    IEtherTokenContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
    ...
    return IEtherTokenContract;
}(base_contract_1.BaseContract));
exports.IEtherTokenContract = IEtherTokenContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_ether_token.js.map