...
export declare type DummyNoReturnERC20TokenEventArgs = DummyNoReturnERC20TokenTransferEventArgs | DummyNoReturnERC20TokenApprovalEventArgs;
...
export declare class DummyNoReturnERC20TokenContract extends BaseContract {
    ...
    static deployFrom0xArtifactAsync(artifact: ContractArtifact | SimpleContractArtifact, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, _name: string, _symbol: string, _decimals: BigNumber, _totalSupply: BigNumber): Promise<DummyNoReturnERC20TokenContract>;
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, _name: string, _symbol: string, _decimals: BigNumber, _totalSupply: BigNumber): Promise<DummyNoReturnERC20TokenContract>;
    /**
