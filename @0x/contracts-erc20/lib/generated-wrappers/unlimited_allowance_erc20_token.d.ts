...
export declare type UnlimitedAllowanceERC20TokenEventArgs = UnlimitedAllowanceERC20TokenTransferEventArgs | UnlimitedAllowanceERC20TokenApprovalEventArgs;
export declare enum UnlimitedAllowanceERC20TokenEvents {
    Transfer = "Transfer",
    Approval = "Approval"
}
...
export declare class UnlimitedAllowanceERC20TokenContract extends BaseContract {
    approve: {
    ...
    static deployFrom0xArtifactAsync(artifact: ContractArtifact | SimpleContractArtifact, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<UnlimitedAllowanceERC20TokenContract>;
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<UnlimitedAllowanceERC20TokenContract>;
    /**
...
//# sourceMappingURL=unlimited_allowance_erc20_token.d.ts.map