...
var UnlimitedAllowanceERC20TokenEvents;
(function (UnlimitedAllowanceERC20TokenEvents) {
    UnlimitedAllowanceERC20TokenEvents["Transfer"] = "Transfer";
    UnlimitedAllowanceERC20TokenEvents["Approval"] = "Approval";
})(UnlimitedAllowanceERC20TokenEvents = exports.UnlimitedAllowanceERC20TokenEvents || (exports.UnlimitedAllowanceERC20TokenEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var UnlimitedAllowanceERC20TokenContract = /** @class */ (function (_super) {
    __extends(UnlimitedAllowanceERC20TokenContract, _super);
    function UnlimitedAllowanceERC20TokenContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'UnlimitedAllowanceERC20Token', UnlimitedAllowanceERC20TokenContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.approve = {
    ...
    UnlimitedAllowanceERC20TokenContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, UnlimitedAllowanceERC20TokenContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    UnlimitedAllowanceERC20TokenContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("UnlimitedAllowanceERC20Token successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new UnlimitedAllowanceERC20TokenContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    UnlimitedAllowanceERC20TokenContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
    ...
    return UnlimitedAllowanceERC20TokenContract;
}(base_contract_1.BaseContract));
exports.UnlimitedAllowanceERC20TokenContract = UnlimitedAllowanceERC20TokenContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=unlimited_allowance_erc20_token.js.map