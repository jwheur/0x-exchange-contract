...
export class ReentrantERC20TokenContract extends BaseContract {
    ...
    public setCurrentFunction = {
        ...
        assert.isNumberOrBigNumber('_currentFunctionId', _currentFunctionId);
        const self = this as any as ReentrantERC20TokenContract;
    ...
    public static async deployAsync(
        ...
        const contractInstance = new ReentrantERC20TokenContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('ReentrantERC20Token', ReentrantERC20TokenContract.ABI(), address, supportedProvider, txDefaults);
