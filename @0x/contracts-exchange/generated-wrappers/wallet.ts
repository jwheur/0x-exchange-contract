...
export class WalletContract extends BaseContract {
    public isValidSignature = {
        ...
        > {
            ...
            assert.isString('eip712Signature', eip712Signature);
    ...
    public static async deployAsync(
        ...
        const contractInstance = new WalletContract(txReceipt.contractAddress as string, provider, txDefaults);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>) {
        super('Wallet', WalletContract.ABI(), address, supportedProvider, txDefaults);
