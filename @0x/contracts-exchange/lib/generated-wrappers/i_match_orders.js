...
var IMatchOrdersContract = /** @class */ (function (_super) {
    ...
    function IMatchOrdersContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IMatchOrders', IMatchOrdersContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.matchOrders = {
    ...
    IMatchOrdersContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, IMatchOrdersContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    IMatchOrdersContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IMatchOrders successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IMatchOrdersContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    IMatchOrdersContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
...
//# sourceMappingURL=i_match_orders.js.map