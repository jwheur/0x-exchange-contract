...
var IMatchOrdersContract = /** @class */ (function (_super) {
    ...
    function IMatchOrdersContract(abi, address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IMatchOrders', abi, address, supportedProvider, txDefaults) || this;
        _this.matchOrders = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new IMatchOrdersContract(abi, txReceipt.contractAddress, provider, txDefaults);
