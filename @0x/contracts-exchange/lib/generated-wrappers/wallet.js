    ...
    WalletContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, walletOwner) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, WalletContract.deployAsync(bytecode, abi, provider, txDefaults, walletOwner)];
            });
        });
    };
    WalletContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, walletOwner) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        ], base_contract_1.BaseContract._bigNumberToString), 1), walletOwner = _a[0];
                        iface = new ethers.utils.Interface(abi);
                        deployInfo = iface.deployFunction;
                        txData = deployInfo.encode(bytecode, [walletOwner
                        ]);
