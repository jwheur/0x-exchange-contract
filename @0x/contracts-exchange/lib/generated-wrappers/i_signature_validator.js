...
var ISignatureValidatorContract = /** @class */ (function (_super) {
    ...
    function ISignatureValidatorContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'ISignatureValidator', ISignatureValidatorContract.ABI(), address, supportedProvider, txDefaults) || this;
        _this.preSign = {
    ...
    ISignatureValidatorContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, ISignatureValidatorContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    ISignatureValidatorContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new ISignatureValidatorContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    ISignatureValidatorContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
