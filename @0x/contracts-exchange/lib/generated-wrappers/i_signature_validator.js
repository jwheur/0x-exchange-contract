...
var ISignatureValidatorContract = /** @class */ (function (_super) {
    ...
    function ISignatureValidatorContract(abi, address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'ISignatureValidator', abi, address, supportedProvider, txDefaults) || this;
        _this.preSign = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new ISignatureValidatorContract(abi, txReceipt.contractAddress, provider, txDefaults);
