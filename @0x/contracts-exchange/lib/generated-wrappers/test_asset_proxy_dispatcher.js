...
(function (TestAssetProxyDispatcherEvents) {
    TestAssetProxyDispatcherEvents["AssetProxyRegistered"] = "AssetProxyRegistered";
})(TestAssetProxyDispatcherEvents = exports.TestAssetProxyDispatcherEvents || (exports.TestAssetProxyDispatcherEvents = {}));
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.publicDispatchTransferFrom.estimateGasAsync.bind(self, assetData, from, to, amount))];
                            case 1:
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                rawCallResult = _a.sent();
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                abiEncoder = self._lookupAbiEncoder('publicDispatchTransferFrom(bytes,address,address,uint256)');
                                result = abiEncoder.strictDecodeReturnValue(rawCallResult);
                                // tslint:enable boolean-naming
                                return [2 /*return*/, result];
                        }
    ...
    TestAssetProxyDispatcherContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, TestAssetProxyDispatcherContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    TestAssetProxyDispatcherContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
