...
var IExchangeCoreContract = /** @class */ (function (_super) {
    ...
    function IExchangeCoreContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IExchangeCore', IExchangeCoreContract.ABI(), address, supportedProvider, txDefaults) || this;
    ...
    IExchangeCoreContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, IExchangeCoreContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    IExchangeCoreContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IExchangeCore successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IExchangeCoreContract(txReceipt.contractAddress, provider, txDefaults);
     ...
     */
    IExchangeCoreContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
...
//# sourceMappingURL=i_exchange_core.js.map