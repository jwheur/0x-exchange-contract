...
var IExchangeCoreContract = /** @class */ (function (_super) {
    ...
    function IExchangeCoreContract(abi, address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IExchangeCore', abi, address, supportedProvider, txDefaults) || this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new IExchangeCoreContract(abi, txReceipt.contractAddress, provider, txDefaults);
