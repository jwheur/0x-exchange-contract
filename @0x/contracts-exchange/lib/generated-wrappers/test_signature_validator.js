...
(function (TestSignatureValidatorEvents) {
    TestSignatureValidatorEvents["SignatureValidatorApproval"] = "SignatureValidatorApproval";
})(TestSignatureValidatorEvents = exports.TestSignatureValidatorEvents || (exports.TestSignatureValidatorEvents = {}));
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                rawCallResult = _a.sent();
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                abiEncoder = self._lookupAbiEncoder('publicIsValidSignature(bytes32,address,bytes)');
                                result = abiEncoder.strictDecodeReturnValue(rawCallResult);
                                // tslint:enable boolean-naming
                                return [2 /*return*/, result];
                        }
    ...
    TestSignatureValidatorContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, TestSignatureValidatorContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    TestSignatureValidatorContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
