...
var IExchangeContract = /** @class */ (function (_super) {
    ...
    function IExchangeContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'IExchange', IExchangeContract.ABI(), address, supportedProvider, txDefaults) || this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new IExchangeContract(txReceipt.contractAddress, provider, txDefaults);
