...
export declare class ReentrantERC20TokenContract extends BaseContract {
    ...
    setCurrentFunction: {
        sendTransactionAsync(_currentFunctionId: number | BigNumber, txData?: Partial<TxData> | undefined): Promise<string>;
        awaitTransactionSuccessAsync(_currentFunctionId: number | BigNumber, txData?: Partial<TxData> | undefined, pollingIntervalMs?: number | undefined, timeoutMs?: number | undefined): PromiseWithTransactionHash<TransactionReceiptWithDecodedLogs>;
        estimateGasAsync(_currentFunctionId: number | BigNumber, txData?: Partial<TxData> | undefined): Promise<number>;
