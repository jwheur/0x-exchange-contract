...
var LibMathContract = /** @class */ (function (_super) {
    ...
    function LibMathContract(abi, address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'LibMath', abi, address, supportedProvider, txDefaults) || this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new LibMathContract(abi, txReceipt.contractAddress, provider, txDefaults);
