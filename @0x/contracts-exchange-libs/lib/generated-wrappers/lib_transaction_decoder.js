...
var LibTransactionDecoderContract = /** @class */ (function (_super) {
    ...
    function LibTransactionDecoderContract(abi, address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'LibTransactionDecoder', abi, address, supportedProvider, txDefaults) || this;
        _this.decodeZeroExTransactionData = {
            callAsync: function (transactionData, callData, defaultBlock) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                encodedData = self._strictEncodeArguments('decodeZeroExTransactionData(bytes)', [transactionData
                                ]);
                            ...
                            case 2:
                                ...
                                abiEncoder = self._lookupAbiEncoder('decodeZeroExTransactionData(bytes)');
    ...
    LibTransactionDecoderContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, LibTransactionDecoderContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    LibTransactionDecoderContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new LibTransactionDecoderContract(abi, txReceipt.contractAddress, provider, txDefaults);
