...
var LibOrderContract = /** @class */ (function (_super) {
    ...
    function LibOrderContract(abi, address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'LibOrder', abi, address, supportedProvider, txDefaults) || this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new LibOrderContract(abi, txReceipt.contractAddress, provider, txDefaults);
