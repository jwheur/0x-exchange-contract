...
var LibOrderContract = /** @class */ (function (_super) {
    ...
    function LibOrderContract(address, supportedProvider, txDefaults) {
        var _this = _super.call(this, 'LibOrder', LibOrderContract.ABI(), address, supportedProvider, txDefaults) || this;
    ...
    LibOrderContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, LibOrderContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    LibOrderContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("LibOrder successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new LibOrderContract(txReceipt.contractAddress, provider, txDefaults);
...
//# sourceMappingURL=lib_order.js.map